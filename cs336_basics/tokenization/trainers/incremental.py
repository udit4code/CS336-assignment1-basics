...
from ._state import IncrementalMergeState, choose_best_pair
from .word_frequency import WordFrequencyBPETrainer


class IncrementalBPETrainer(WordFrequencyBPETrainer):
    """Update pair statistics only in words changed by the selected merge."""
